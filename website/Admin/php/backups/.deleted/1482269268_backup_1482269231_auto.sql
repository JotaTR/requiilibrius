UPDATE requilib_website.funcionario SET nome = 'Alexandra Oliveira', resumo = 'Fisioterapeuta licenciada p' WHERE id = '2';UPDATE requilib_website.funcionario SET nome = 'Alexandra Oliveira', resumo = 'Fisioterapeuta licenciada p' WHERE id = '2';UPDATE requilib_website.funcionario SET nome = 'Alexandra Oliveira', resumo = 'Fisioterapeuta lic' WHERE id = '2';UPDATE 
