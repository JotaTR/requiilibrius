UPDATE requilib_website.funcionario SET nome = 'Alexandra Oliveira', resumo = 'Fisioterapeuta licenciada pela Escola Superior do Alc' WHERE id = '2';UPDATE 
			...
			and id = '30';UPDATE 
						...
						WHERE 
							funcionario_id = '2' 
			and id = '31';UPDATE requilib_website.destaque 
				  SET titulo = 'Fisioterapeutas da R\'equilibr',
