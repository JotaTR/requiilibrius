UPDATE requilib_website.destaque 
				  SET titulo = 'Fisioterapeutas da R\'equilibrius participaram no',
				...
				WHERE id = '2';UPDATE requilib_website.funcionario SET nome = 'Alexandra Oliveira', resumo = 'Fisioterapeuta licenciada pela Escola Superior do Alcoitão e responso em diversos mestrados, nomeadamente Ciências da Fisioterapia, Saúde da Mulher, Pediatria, e docente na Escola Superior de Alcoitão. Orientadora de estágios em contexto clínico. e coautora de diversos artigos científicos.' WHERE id = '2';UPDATE 
