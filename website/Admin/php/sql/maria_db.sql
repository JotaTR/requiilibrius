	...
	INSERT INTO requilib_website.cvitem (funcionario_id, seq, field, content) VALUES ((SELECT id FROM requilib_website.funcionario WHERE nome = 'Alexandra Oliveira'), 180 , 'Publicações Científicas', 'Flavia Correa, Manuel Cunha, Ana Cadete, Alexandra Oliveira, Helena Figueiredo, Rosalina BARRO¬SO, Helena CARREIRO. <strong>PO23: Cerebellar Growth in Preterm Infants: A Longitudinal Sonographic Study.</strong> 3rd International Congress of UENPS 2012, Acta Med Port 2012;25(S2):152.');
	INSERT INTO requilib_website.cvitem (funcionario_id, seq, field, content) VALUES ((SELECT id FROM requilib_website.funcionario WHERE nome = 'Alexandra Oliveira'), 190 , 'Publicações Científicas', 'Manuel Cunha, Flávia Correa, Ana Cadete, Alexandra Oliveira, Helena Figueiredo, Paula Valério, Ro¬salina Barroso, Helena Carreiro. <strong>Neurodevelopment in Very Preterm In¬fants at 18 Months’ Corrected Age: the Role of Cerebellar Growth and General Movements Assessments. CO56</strong>: 3rd International Congress of UENPS 2012, Acta Med Port 2012;25(S2):140.');
